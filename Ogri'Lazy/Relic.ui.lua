...
local function Relic_BuffUpdate(self)
    ...
    -- If we didn't find the debuff and it was previously present, trigger shift
    if not found and Relic_DebuffExpire > 0 then
        Relic_DebuffExpire = 0;
        Relic_ShiftRight();
    end
end
]]
...
if Relic_View then 
 ...
 Relic_View_ClearButton:SetText(Relic_lang.clearAll or "Clear All");
